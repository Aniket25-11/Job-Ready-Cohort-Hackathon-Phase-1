        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
          ...
          <div className="relative h-48 bg-gradient-to-r from-indigo-600 to-purple-600 flex items-center justify-center">
            <div className="absolute inset-0 overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 w-40 h-40 bg-pink-400/20 rounded-full filter blur-xl"></div>
            </div>
              ...
              <div className="space-y-5">
                ...
                <motion.div whileHover={{ scale: 1.02 }}>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all"
                      placeholder="••••••••"
                    />
                    <button
                      type="button"
                ...
                >
                  <button
                    type="submit"
                    disabled={loading}
                    className={`w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all ${loading ? 'opacity-70' : ''}`}
                  >
                    {loading ? (
                      'Creating account...'
                    ) : (
