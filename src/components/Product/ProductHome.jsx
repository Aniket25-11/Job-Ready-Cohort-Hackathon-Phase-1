...
import { FiShoppingCart, FiBookOpen, FiArrowRight, FiFilter, FiX, FiStar, FiChevronRight } from 'react-icons/fi';
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-6 mb-16">
          ...
          >
            {["all", "mindset", "productivity", "finance", "career"].map(category => (
              <button
                ...
                className={`px-5 py-2 text-black rounded-full text-sm font-medium transition-all ${activeFilter === category ? 
          ...
          >
            <button
              ...
              className="flex items-center gap-2 px-5 py-2 bg-white border border-gray-200 rounded-full shadow-sm hover:shadow-md transition-all"
            >
...
{/* CompleteCollectionCTA  */}
  ...
  >
    ...
    <div className="relative bg-gradient-to-br from-purple-900 to-pink-700 rounded-3xl p-8 md:p-12 text-white overflow-hidden shadow-xl">
      {/* Subtle background white circles */}
      ...
      <div className="relative z-10">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            {/* Buy Button with Glow, Hover, Pulse */}
            <motion.button
